...
<head>
  ...
  <title>@yield('title','Blog Sitesi') - {{$setting->baslik}}</title>
    <!-- yield('title','Default Title')   tittle gelmesse-->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="/">@if($setting->logo) <img src="{{$setting->logo}}" width="150px"></img> @else  {{$setting->baslik}} @endif</a>
